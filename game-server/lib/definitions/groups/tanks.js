...
// Custom addition: a tier-1 fan-spread tank, sibling to Twin/Sniper/Pounder.
// Three forward-facing barrels in a narrow fan. Each barrel hits lighter than
// Basic's single gun (tripleShot gunval), trading raw damage for spread coverage
// and making it harder for enemies to dodge at close-to-mid range.
Class.trident = {
    PARENT: 'genericTank',
    LABEL: "Trident",
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.tripleShot]),
                TYPE: 'bullet'
            }
        },
        {
...
// Class Tree
Class.basic.UPGRADES_TIER_1 = ['twin', 'sniper', 'machineGun', 'flankGuard', 'director', 'pounder', 'trapper', 'desmos', 'trident']
    ...
    Class.trident.UPGRADES_TIER_2 = ['tripleShot', 'gunner', 'sprayer']
